...
This website is written in Javascript using the React framework. Requests are made to the Brawlhalla API in order to gather specific information requested by the user using various front-end interface items. This website is currently being hosted on Netlify under the domain name: https://brawlsearch.netlify.app/
